...
?>
   ...
   <a href="#" class="navbar-brand"><img src="logo1.jpg" class="img-fluid pt-2" height=50; width=100;></a>
   ...
   <div class="collapse navbar-collapse" id="navbarCollapse">
     ...
     <div class="form-inline ml-auto">
         <button type="submit" class="btn btn-outline-light" onclick="sign()"> Log In</button>
         <button type="submit" class="btn btn-outline-light" onclick="sign()">Register</button>
     </div>
   </div>
</nav>
   </header>
   <div class="container">
           ...
           <div class="container">
             <div class="row">
               <div class="col-md-6"><b>Customer Id : </b><?php echo $rows['id'] ?></div>
               <div class="col-md-6"><b>Name : </b><?php echo $rows['name'] ?></div>
             </div>
           </div>
           <div class="container">
             <div class="row">
               <div class="col-md-6"><b>Email address : </b><?php echo $rows['email'] ?></div>
        ...
        <br>
            ...
            <button class="btn btn-dark mt-3" name="submit" type="submit" id="myBtn" >Send</button>
            </div>
        </form>
    </div>
    <script>
